            ...
            <v-flex xs12>
                <v-timeline :dense="$vuetify.breakpoint.smAndDown"
                    ...
                    >
                        ...
                        ></span>
                        <div class="py-4">
                            <h2 :class="`title font-weight-regular ${item.color}--text text--${item.color_variant} pb-1`"
                                v-text="$prismic.richTextAsPlain(item.qualification)"
                            ></h2>
                            <span :class="`font-weight-regular ${item.color}--text text--${item.color_variant} pb-3`"
                                  v-text="item.grade">
                            </span>
                            <br v-if="item.grade">
                            ...
                            <div class="text--darken-1 pb-1 hidden-md-and-up"
