...
export const socials = [
    ...
    {type: "email" as const, href: "mailto:contact@eriksanne.com", label: "Email"},
];
...
export interface Experience {
    ...
    period: string;
    roles: Role[];
    /** Combined description shown in the expanded view when there are multiple roles. */
    description?: string;
    /** Combined skill tags shown in the expanded view when there are multiple roles. */
    skills?: string[];
}
...
export const professionalExperience: Experience[] = [
    ...
    },
    {
        ...
        description: "Built and maintained data-driven microservices powering ESG analytics. Implemented scoring methodologies in Go and Python and developed batch-driven data pipelines for processing large financial datasets.\n" +
            "Developed core infrastructure including database wrappers, CI/CD pipelines, data delivery mechanisms, and Terraform-based IaC components. Advocated for improved testing practices, significantly enhancing test coverage and code quality.",
        skills: ["Go", "Python", "Postgres", "gRPC", "Terraform", "Kubernetes", "ArgoCD", "Helm", "Docker", "CI/CD"],
        roles: [
            {
        ...
        roles: [
            {
                ...
                skills: ["Java", "Spring-Boot", "MongoDB", "AWS Lambda", "OpenShift", "Azure", ],
            },
        ],
    },
];
...
export const earlyCareer: Experience[] = [
    {
        ...
        roles: [{
            ...
            period: "Sep 2020 — Dec 2020",
            description: "Assisted in practical sessions for the Software Engineering 3 module, " +
                "guiding students through C# development tasks and providing individualised support to enhance understanding of software engineering principles.",
    ...
    },
    {
        ...
        roles: [{
            ...
            period: "Jul 2020",
            description: "Participated in a virtual insight week for interns, engaging in engineering talks, " +
                "technical discussions, and personal development sessions to gain insights into Skyscanner's engineering practices.",
            skills: ["Software Engineering", "Best Practices", "Networking"],
        }],
    },
    {
        company: "MarketAxess",
        ...
        roles: [{
            ...
            period: "Jun 2019 — Aug 2019",
            description: "Supported the trading technology team as a product owner and provided data analysis for post-sales in electronic fixed-income trading.",
    ...
    },
    {
        ...
        roles: [{
            ...
            description: "Completed a 12-month placement split between Equity Swaps Trading and Development Environment teams.\n" +
                ...
                "Led a migration from Perl to Java Spring Boot, driving increased revenue and client retention.\n" +
                "Built a RESTful API with Freemarker templating to streamline project setup for developers across the firm.",
            skills: ["Java", "Spring-Boot", "REST APIs", "Perl", "DB2", "Performance Tuning"],
        }],
    },
    {
        ...
        roles: [{
            ...
            period: "May 2017 — May 2018",
            description: "Monitored customer transactions to identify suspicious activity.\n" +
                "Analysed historical data to uncover inefficiencies, providing actionable insights to stakeholders and enabling the team to focus on complex transactions.",
